...
os.environ.setdefault("CLAUDE_PERMISSION_ARCHIVE_FILE", str(_tmp / "permission_requests.archive.jsonl"))
os.environ.setdefault("CLAUDE_MANUAL_CONFIRM_LOG", str(_tmp / "bash_manual_confirm.log"))
